...
```bash
# Read main file
cat ~/.factory/skills/{skill-name}/SKILL.md

# Check for workflows and references
ls ~/.factory/skills/{skill-name}/
ls ~/.factory/skills/{skill-name}/workflows/ 2>/dev/null
ls ~/.factory/skills/{skill-name}/references/ 2>/dev/null
```
