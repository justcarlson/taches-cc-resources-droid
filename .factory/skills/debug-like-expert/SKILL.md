...
ls ~/.factory/skills/expertise/ 2>/dev/null | head -5
```
...
<domain_expertise>
**Domain-specific expertise lives in `~/.factory/skills/expertise/`**
...
```bash
cat ~/.factory/skills/expertise/[domain]/references/*.md 2>/dev/null
```
