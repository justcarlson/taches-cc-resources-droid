...
<purpose>
Scripts are executable code that Droid runs as-is rather than regenerating each time. They ensure reliable, error-free execution of repeated operations.
</purpose>
...
The workflow tells Droid WHEN to run the script. The script handles HOW the operation executes.
</workflow_integration>
