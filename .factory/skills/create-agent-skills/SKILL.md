...
description: Expert guidance for creating, writing, building, and refining Factory CLI Skills. Use when working with SKILL.md files, authoring new skills, improving existing skills, or understanding skill structure and best practices.
---
...
All prompting best practices apply. Be clear, be direct, use XML structure. Assume Droid is smart - only add context Droid doesn't have.

### 2. SKILL.md Is Always Loaded

When a skill is invoked, Droid reads SKILL.md. Use this guarantee:
...
- **workflows/** - Multi-step procedures Droid follows
- **references/** - Domain knowledge Droid reads for context
- **templates/** - Consistent output structures Droid copies and fills (plans, specs, configs)
- **scripts/** - Executable code Droid runs as-is (deploy, setup, API calls)
...
templates/:
  Output structures Droid copies and fills
  (plans, specs, configs, documents)

scripts/:
  Executable code Droid runs as-is
