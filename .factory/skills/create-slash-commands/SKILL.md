...
description: Expert guidance for creating Factory CLI slash commands. Use when working with slash commands, creating custom commands, understanding command structure, or learning YAML configuration.
---

<objective>
Create effective slash commands for Factory CLI that enable users to trigger reusable prompts with `/command-name` syntax. Slash commands expand as prompts in the current conversation, allowing teams to standardize workflows and operations. This skill teaches you to structure commands with XML tags, YAML frontmatter, dynamic context loading, and intelligent argument handling.
</objective>

<quick_start>

<workflow>
1. Create `.factory/commands/` directory (project) or use `~/.factory/commands/` (personal)
...
<example>
**File**: `.factory/commands/optimize.md`
...
Droid receives the expanded prompt and analyzes the code in context.
</example>
</quick_start>
...
**Project commands**: `.factory/commands/`
- Shared with team via version control
- Shows `(project)` in `/help` list

**Personal commands**: `~/.factory/commands/`
...
**Optional** - Restricts which tools Droid can use
...
**Command file**: `.factory/commands/fix-issue.md`
```markdown
---
...
**Droid receives**: "Fix issue #123 high-priority following our coding standards"
</all_arguments_string>

<positional_arguments_syntax>

**Command file**: `.factory/commands/review-pr.md`
```markdown
---
...
**Droid receives**: "Review PR #456 with priority high and assign to alice"
...
Droid can access the referenced file's contents.
</file_references>
...
6. **Save the file**:
   - Project: `.factory/commands/command-name.md`
   - Personal: `~/.factory/commands/command-name.md`
</generation_protocol>
