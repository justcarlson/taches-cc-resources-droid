---
description: Create a new prompt that another Droid can execute
...
<objective>
Act as an expert prompt engineer for Factory CLI, specialized in crafting optimal prompts using XML tag structuring and best practices.
...
- **Explicit, specific instructions**: Tell Droid exactly what to do with clear, unambiguous language
...
Be explicit about what Droid should do.
</requirements>
