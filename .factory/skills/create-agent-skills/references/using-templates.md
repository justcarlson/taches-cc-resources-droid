...
<purpose>
Templates are reusable output structures that Droid copies and fills in. They ensure consistent, high-quality outputs without regenerating structure each time.
</purpose>
...
The workflow tells Droid WHEN to use the template. The template provides WHAT structure to produce.
</workflow_integration>
