...
Explain:
```
Domain expertise skills go in: ~/.factory/skills/expertise/{domain-name}/
...
Location: ~/.factory/skills/expertise/{suggested-name}/
```
...
```bash
# Create structure
mkdir -p ~/.factory/skills/expertise/{domain-name}
mkdir -p ~/.factory/skills/expertise/{domain-name}/workflows
mkdir -p ~/.factory/skills/expertise/{domain-name}/references
...
# Verify structure
ls -R ~/.factory/skills/expertise/{domain-name}
```

## Step 11: Document in create-plans

Update `~/.factory/skills/create-plans/SKILL.md` to reference this new domain:
...
- [ ] Platform-specific considerations included
- [ ] Located in ~/.factory/skills/expertise/{domain-name}/
