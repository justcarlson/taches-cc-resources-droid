...
<principle>
When Droid performs complex, open-ended tasks, create a plan in a structured format, validate it, then execute.
...
Specific errors help Droid fix issues without guessing.
</implementation_tip>
...
<principle>
Guide Droid through decision points with clear branching logic.
</principle>
...
- Guiding Droid to correct path improves outcomes
</when_to_use>
</conditional_workflows>

<validation_scripts>
<principles>
Validation scripts are force multipliers. They catch errors that Droid might miss and provide actionable feedback for fixing issues.
</principles>
...
Verbose errors help Droid fix issues in one iteration instead of multiple rounds of guessing.
</verbose_errors>
...
Actionable suggestions show Droid exactly what to fix.
</actionable_suggestions>
...
<checkpoint_pattern>
<principle>
For long workflows, add checkpoints where Droid can pause and verify progress before continuing.
</principle>
...
<error_recovery>
<principle>
Design workflows with clear error recovery paths. Droid should know what to do when things go wrong.
</principle>
