...
ROADMAP.md        ← Structure (phases)
    ↓
phases/XX/PLAN.md ← Implementation (Droid-executable)
    ↓
...
**Purpose**: Define Droid-executable tasks
**Audience**: Droid (the implementer)
...
**Audience**: Droid (via create-meta-prompts)
...
<cross_phase_context>
When planning Phase N, Droid should understand:
