...
<description>
Skills use pure XML structure for consistent parsing, efficient token usage, and improved Droid performance.
</description>
...
<parseability>
XML provides unambiguous boundaries and semantic meaning. Droid can reliably:
...
Markdown headings are just visual formatting. Droid must infer meaning from heading text, which is less reliable.
</parseability>
...
## Success criteria
```
Total: ~20 tokens, no semantic meaning to Droid
...
<claude_performance>
Droid performs better with pure XML because:
...
<guidance>
Only add context Droid doesn't already have. Challenge each piece of information:
- "Does Droid really need this explanation?"
- "Can I assume Droid knows this?"
- "Does this paragraph justify its token cost?"

Assume Droid is smart. Don't explain obvious concepts.
</guidance>
...
The concise version assumes Droid knows what PDFs are, understands Python imports, and can read code. All those assumptions are correct.
</concise_example>
...
<description>
Match the level of specificity to the task's fragility and variability. Give Droid more freedom for creative tasks, less freedom for fragile operations.
</description>
...
Droid has freedom to adapt the review based on what the code needs.
</example>
</high_freedom>
...
Droid can customize the template based on requirements.
</example>
</medium_freedom>
...
Droid must follow the exact command with no variation.
</example>
</low_freedom>
...
<description>
SKILL.md serves as an overview. Reference files contain details. Droid loads reference files only when needed.
</description>
...
<description>
Validation scripts are force multipliers. They catch errors that Droid might miss and provide actionable feedback.
</description>
...
<principle_summary>
<xml_structure>
Use pure XML structure for consistency, parseability, and Droid performance. Required tags: objective, quick_start, success_criteria.
</xml_structure>

<conciseness>
Only add context Droid doesn't have. Assume Droid is smart. Challenge every piece of content.
</conciseness>
